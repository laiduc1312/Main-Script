                ...
                if _G.AutoSharkman then
                    ...
                    if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate"), "keys") then  
                        if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Water Key") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Water Key") then
                            to(CFrame.new(-2604.6958, 239.432526, -10315.1982, 0.0425701365, 0, -0.999093413, 0, 1, 0, 0.999093413, 0, 0.0425701365))
                        ...
                        elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 400 then
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then   
                                ...
                                to(CFrame.new(-3570.18652, 123.328949, -11555.9072, 0.465199202, -1.3857326e-08, 0.885206044, 4.0332897e-09, 1, 1.35347511e-08, -0.885206044, -2.72606271e-09, 0.465199202))
                                wait(3)
                            end
                        end
                    else 
                    ...
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") then
                        if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 400 then
                            if _G.AutoFarm == false then
                                repeat task.wait()
                                    to(CFrame.new(-10371.4717, 330.764496, -10131.4199))
                                until not _G.AutoElectricClaw or (game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - CFrame.new(-10371.4717, 330.764496, -10131.4199).Position).Magnitude <= 10
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw","Start")
                                wait(2)
                                repeat task.wait()
                                    to(CFrame.new(-12550.532226563, 336.22631835938, -7510.4233398438))
...
TeleTab:AddParagraph("Teleport Sea","")
...
TeleTab:AddParagraph("Bypass Teleport","")
if World1 then
    TeleTab:AddDropdown({
        Name = "Select Island",
        Default = "...",
...
if World3 then
    ...
    function GATCAN()
        ...
        if game:GetService("Workspace").Map["Temple of Time"].Lever.Lever.CFrame.Z > bo.Z + bp or game:GetService("Workspace").Map["Temple of Time"].Lever.Lever.CFrame.Z < bo.Z - bp then
            CheckTemple()
            to(game:GetService("Workspace").Map["Temple of Time"].Lever.Part.CFrame)
...
V4:AddParagraph("Kill Player","")
V4:AddToggle({
	Name = "Kill Player When Trial",
	Default = false,
	Callback = function(Value)
		KillPlayer = Value
	end    
    ...
    spawn(function()
        while wait() do
            if KillPlayer then
                for _, playerCharacter in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if playerCharacter.Name ~= game.Players.LocalPlayer.Name and (playerCharacter.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 400 then
                        local humanoid = playerCharacter:FindFirstChildOfClass("Humanoid")
                        if humanoid and humanoid.Health > 0 then
                            repeat wait()
                                AutoHaki()
                                EquipWeapon(_G.SelectWeapon)
                                NameTarget = playerCharacter.Name
                                to(playerCharacter.HumanoidRootPart.CFrame * CFrame.new(0, 5, 5))
                                playerCharacter.HumanoidRootPart.CanCollide = false
                                playerCharacter.Head.CanCollide = false
                                playerCharacter.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                Click()
                            until not KillPlayer or not playerCharacter.Parent or humanoid.Health <= 0
                        end
                        if game.Players.LocalPlayer.Character.Humanoid.Health < 5000 then
                            center = playerCharacter.HumanoidRootPart.CFrame * CFrame.new(0, 5, 5)
                            to(getNextPosition())
                        end
                    end
                end
